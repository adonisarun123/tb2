      ...
      <div className="max-w-[1440px] mx-auto px-4 md:px-24">
        <div className="text-center mb-16">
          <h2 className="text-[40px] font-bold text-[#313131] mb-4">
            Top Resorts In and Around Bangalore
          </h2>
          <p className="text-lg text-[#636363] max-w-3xl mx-auto">
            From serene nature escapes to action-packed recreational resorts, discover the best destinations for relaxation, adventure, and quality time with loved ones, all nestled in and around the Garden City.
          </p>
        </div>
...
export default BestBangaloreStaysSection; 